...
![pdf去水印-选中文字.png](images/pdf去水印-选中文字.png)

- 图片水印，此类水印需要分为2种
  - 正文中嵌入水印图片，典型的像是扫描全能王的水印

      ![pdf去水印-选中图片.png](images/pdf去水印-选中图片.png)
...
- 图形水印，将unicode文字用贝尔曲线画出来的图形（画图工具嵌入的文字就是贝尔曲线），可以选中但是文字复制不出来，这种水印是难以识别的，文字转图形以后就无法在转回来了。不过软件可以将这块内容标记出来，供大家判别是否为水印。
    ...
    ![pdf去水印-选中图形.png](images/pdf去水印-选中图形.png)
...
![pdf去水印-图片水印.png](images/pdf去水印-图片水印.png)
...
![pdf去水印-文字水印.png](images/pdf去水印-文字水印.png)
...
![pdf转word-控制台](images/pdf转word-控制台.png)

# 三、PDF批量加密文件

PDF批量加密功能，选择目录会遍历目录下的所有PDF文件，展示在下方表格中。可以取消勾选来取消加密文件

![pdf批量加密-选择目录](images/pdf批量加密-选择目录.png)
...
![pdf批量机密-加密选项](images/pdf批量机密-加密选项.png)
...
![image-20211229153634052](images/pdf转图片-截图.png)
