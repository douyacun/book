...
![](assert/go-memory-allocator.png)
...
span中一个指针(8 Byte)对应了arena区域中的一页(page 8KB)

64 G的arena有64G/8KB = 8388608个page 8388608 * 8 byte = 64M

### bitemap

标记area中哪些地址包含了对象，哪些地址包含了指针

bitemap区域中一个byte(8 bit)对应arena区域中4个页（page）大小的内存，2bit对应一个页（page）

64G / 8KB = 8388608个页。  8388608 / 4  = 2GB的bitemap
