---
Title: redis/sds源码学习
Keywords: sds,Simple Dynamic Strings,sds原理
Description: 简单的动态字符串
Author: douyacun
Date: 2019-05-09 10:46:58
LastEditTime: 2019-07-12 22:54:33
---

# 工作原理

sds是c的字符串，旨在通过堆分配的字符串来增强有限的libc字符串功能
