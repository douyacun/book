...
因为React是不建议嵌套html代码的，需要使用 `dangerouslySetInnerHTML={{ __html: md.render(article.content) }}` 嵌入html才可以

# TOC 目录列表 加 锚点

[markdown-it-toc-done-right](https://github.com/nagaozen/markdown-it-toc-done-right)

[markdown-it-anchor](https://github.com/nagaozen/markdown-it-toc-done-right)
...
[github.css](https://github.com/teablog/ui/blob/master/src/css/github-markdown.css) 这里也贴一下，样式就是现在看到的样式。
