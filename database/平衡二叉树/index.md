---
Title: 平衡二叉树
LegacyId: 72ab6fdd9b48ba48c7810e04613c4643
Slug: 平衡二叉树
Category: database
Summary: '分析几个问题: 1. 为什么不用平衡二叉树? 2. B树、B+树有什么性质、区别? 3. 联合索引的B+树长什么样? 4. MyisAM索引数据结构？
  **性质** 1. 非叶子节点最多只能有2个子节点 2. 非叶子节点中间值大于左边，小于'
SeoTitle: 平衡二叉树
SeoDescription: '分析几个问题: 1. 为什么不用平衡二叉树? 2. B树、B+树有什么性质、区别? 3. 联合索引的B+树长什么样? 4. MyisAM索引数据结构？
  **性质** 1. 非叶子节点最多只能有2个子节点 2. 非叶子节点中间值大于左边，小于'
